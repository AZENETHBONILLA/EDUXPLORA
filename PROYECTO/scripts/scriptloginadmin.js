...
const urlAgregarUsuario = 'http://localhost/explora/agregarUsuario.php'
...
const objEmpleado = {
    ...
    usuario: '',
    contrasena: '',
    cargo: 'administrador' // Cambiando "email" por "cargo" y estableciendo el valor predeterminado como "administrador"
}
