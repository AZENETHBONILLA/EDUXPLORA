...
// Variables globales para almacenar idEmpresa y nombre
        ...
        .then(responseData => {
            ...
            if (responseData.error) {
                ...
                responseData.empresas.forEach(function (empresa) {
                    ...
                    enlaceSolicitar.addEventListener('click', function () {
                        // Guardar idEmpresa y nombre al hacer clic en el botón "SOLICITAR"
                        idEmpresaSeleccionada = empresa.idEmpresa;
                        nombreEmpresaSeleccionada = empresa.nombre;
                    });
                ...
                // Agregar evento clic al botón "GUARDAR" en la ventana flotante
                ...
                if (!idUsuario || !grupo || !carrera) {
                    alert('Todos los campos son obligatorios');
                    return;
                }

                // Construir la URL de la solicitud
                var url = "http://localhost/eduxplora/solicitud.php?idEmpresa=" + idEmpresaSeleccionada + "&nombreEmpresa=" + nombreEmpresaSeleccionada + "&grupo=" + grupo + "&idUsuario=" + idUsuario + "&carrera=" + carrera;
                ...
                // Realizar la solicitud HTTP utilizando fetch
                    ...
                    .then(data => {
                        ...
                        if (data.success === true) {
                            ...
                            // Manejar el caso en que la respuesta no indique éxito
                            alert("La solicitud no fue exitosa. Mensaje: " + data.message); // Puedes ajustar esto según el formato de respuesta
                        }
                    });
